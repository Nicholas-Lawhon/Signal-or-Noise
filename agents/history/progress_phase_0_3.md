# Progress Archive - Phases 0-3

Detailed historical session log moved out of progress.md on 2026-07-09 as part of D030 state compaction. progress.md remains the live dashboard; this file is for historical lookup only.

## Phase Summaries

### Phase 0 - Project Setup
- Scaffolded the pnpm monorepo, Next.js web app, game-engine package, content placeholder, base docs, and agent workflow.
- Key artifacts: H001, A001/A002 audit path, initial reports.
- Status: complete and audited by A002.

### Phase 1 - Static Classic Run Prototype
- Built the playable Classic Run prototype, scoring flow, difficulty setup, reveal, summary, bankruptcy, Call the Company, and placeholder scenario variety.
- Key fixes: H003 gameplay fixes, H005 A001 blockers, H006 scenario variety and reveal banner.
- Status: complete and audited by A002.

### Phase 2 - Game Engine Hardening
- Hardened pure game-engine APIs and tests: `advanceRun`, streak tracking, leaderboard tiebreakers, bankruptcy behavior, and run summary coverage.
- Key artifacts: H012 / R009.
- Status: complete with 37 game-engine tests.

### Phase 3 - Scenario Schema & Content Pipeline
- Added `@signal-or-noise/content` schema, validation API/CLI, JSON scenario folders, active seed scenarios, and JSON-backed Classic Run loading.
- Key fixes: H016 browser-safe content exports/build fix; H018 A005 major validator/content fix-ups.
- Audit: A005 PASS WITH FINDINGS; A005 MAJORs closed by H018, MINORs carried into Phase 4 Part A.
- Status: complete; Phase 4 Part A is active.

## Carried Forward

- C003 automated Gate 2 consultation awaits orchestrator/user review.
- A005 MINORs 1/2/4 remain Phase 4 Part A work.
- Composite Final Score / Information Tiers remains an open design question.

## Detailed Archived Session Log

### 2026-07-09 â€” Orchestrator â€” A005 accepted; Phase 3 work committed; H018 drafted
...
**Known issues:**
- A005 MAJORs 1â€“3 open until H018 lands; MINORs 1â€“4 deferred to Phase 8.
...
### 2026-07-09 â€” Auditor â€” H017/A005 content-pipeline audit: PASS WITH FINDINGS (see `agents/audits/A005_H015-H016.md`)

### 2026-07-09 â€” Orchestrator â€” R012 accepted; H017 audit drafted
...
### 2026-07-09 â€” Implementor â€” H016 H015 build fix
...
- Report: `agents/reports/R012_H016.md`. Handoff status â†’ complete.
- Left all work uncommitted (D012).

**How to run:** unchanged; `pnpm build` now succeeds.

**Tests:** 47 passing / 0 failing â€” `pnpm typecheck`; `pnpm test`
...
### 2026-07-09 â€” Orchestrator â€” R011 review rejected; H016 drafted
...
### 2026-07-09 â€” Implementor â€” H015 Phase 3 scenario schema & content pipeline
...
- Report: `agents/reports/R011_H015.md`. Handoff status â†’ complete.
- Left all work uncommitted (D012).
...
- `pnpm dev` â†’ Classic Run at `/play/classic`
...
### 2026-07-09 â€” Orchestrator â€” D026 + H015 Phase 3 handoff
...
**Tests:** not run â€” docs/handoff only.
...
### 2026-07-09 â€” Orchestrator â€” C002/H014 review
...
**Tests:** 37 passing / 0 failing â€” `pnpm typecheck`; `pnpm test`.
...
### 2026-07-08 â€” Consultant â€” H013 / C002 scenario information design
...
**Tests:** n/a â€” consultation only.

**Blocked/Questions:** none â€” recommendation awaits orchestrator/user decision.

**Next recommended task:** review C002; record decision; update docs 06/09; then Phase 3 schema handoff.

### 2026-07-08 â€” Implementor â€” H014 variable Classic Run lengths
...
- Report: `agents/reports/R010_H014.md`. Handoff status â†’ complete.
- Left all work uncommitted (D012).
...
### 2026-07-09 â€” Orchestrator â€” H013 drafted + D025 round counts
...
### 2026-07-09 â€” Orchestrator â€” Phase 3 readiness check
...
### 2026-07-09 â€” Orchestrator â€” H012 review accepted under D024
...
### 2026-07-09 â€” Implementor â€” H012 Phase 2 game engine hardening
...
- Expanded tests: zero return incorrect, streaks, advanceRun end/ongoing,
  leaderboard sortKey, guards. Suite 24 â†’ 37 tests.
- Report: `agents/reports/R009_H012.md`. Handoff status â†’ complete.
- Left all work uncommitted (D012).
...
### 2026-07-09 â€” Orchestrator â€” H012 drafted for Phase 2 engine hardening
...
**Tests:** not run â€” handoff draft only.
...
### 2026-07-09 â€” Orchestrator â€” D024 development-speed review policy
...
### 2026-07-09 â€” Auditor â€” H011 / A004 content re-audit: FAIL (see `agents/audits/A004_H011.md`)

### 2026-07-09 â€” Implementor (curator) â€” H011 placeholder content fix-up
...
**Tests:** 24 passing / 0 failing â€” `pnpm typecheck`; `pnpm test`.
...
### 2026-07-09 â€” Auditor â€” H010 / A003 content audit of H009: FAIL (see `agents/audits/A003_H009.md`)

### 2026-07-08 â€” Orchestrator â€” D023: Grok 4.5, characteristic routing, direct CLI dispatch
...
- Rewrote `agents/routing.md`; synced `agents/roles/orchestrator.md`,
  `agents/README.md`, `agents/handoffs/TEMPLATE.md` (Model tier â†’ Model field).
...
**Tests:** n/a â€” docs-only change; CLI smoke tests passed as above.

**Blocked/Questions:** Grok 4.5 Style rating is TBD â€” user rates it after
Grok's first 2â€“3 handoffs.
...
### 2026-07-07 â€” Orchestrator â€” C001 accepted; rulebook fixes landed; H009 drafted

**What changed:**
- Reviewed C001 (verdict: adopt with fixes â€” found the rulebook exploitable
...
- Doc 09 updated: distinctive-hook + hindsight-thesis bans, ladder escalation
  ...
  plausible-alternative minimums (Easy â‰¥2 / Medium 2â€“4 / Hard â‰¥4), sharpened
...
**Tests:** n/a â€” docs only this session.
...
### 2026-07-06 â€” Orchestrator â€” D022 amendment: merged GPT 5.5 memo additions into the rulebook
...
- User shared an independent GPT 5.5 memo on scenario difficulty. Compared it
  ...
  (Medium calibrated to 2â€“4 plausible alternatives). Rejected: its retention
...
- Doc 09: rewrote AI Generation Workflow â†’ Authoring Workflow (fact bank,
...
**Tests:** n/a â€” docs only.

**Blocked/Questions:** none.

**Next recommended task:** unchanged â€” user approves + runs H008 on GPT 5.5,
then H009 placeholder regeneration.

### 2026-07-06 â€” Orchestrator â€” D022: difficulty-scaled clues + Scenario Content Rulebook

**What changed:**
- Playtest feedback: repetition (expected â€” 12 cards, 20 rounds) and trivial
  ...
  D006 shortcut â€” difficulty only changed bankroll), and doc 09's difficulty
  rules were one vague sentence per level.
- Recorded D022 (user approved): clue counts scale Easy 3 / Medium 2 / Hard 1;
  binding Scenario Content Rulebook written into doc 09 â€” universal bans +
  three-companies test, field roles, L1â€“L4 specificity ladder with per-
...
- Authored H008 (draft): GPT 5.5 adversarial review of the rulebook â†’
...
**Tests:** n/a â€” docs only; no code touched.
...
### 2026-07-06 â€” Orchestrator â€” Workflow rework: model routing & risk tiers (D021)

**What changed:**
- Recorded D021 in `decisions.md`: routing-first workflow â€” orchestrator (Fable)
...
**Tests:** n/a â€” docs-only change.

**Blocked/Questions:** none.

**Next recommended task:** unchanged â€” pick the next thread (Gate A Growth
...
### 2026-07-03 â€” Orchestrator â€” A002 review, Phase 1 closed
...
- Marked R005/R006 approved; roadmap Phases 0 + 1 â†’ âœ…; current phase â†’ 2.

**Next recommended task:** Orchestrator + user pick the next thread â€” Gate A Growth
...
### 2026-07-03 â€” Implementor â€” H006 Scenario Variety + Win/Loss Reveal

**What changed:**
- Part A: Appended 6 new placeholder scenarios (Coca-Cola, Starbucks, Nvidia, GE, Boeing, Visa) to SCENARIOS array â€” total pool now 12. All hidden-card fields leak-checked per D018.
- Part B: Rewrote `buildRunScenarioList` â€” exhausts full pool in shuffled laps before repeating, with boundary-repeat guard (swaps first entry of new lap if it matches last emitted card).
- Part C: Added win/loss/pass/break-even banner at top of reveal card: green `+$â€¦` for wins, red `âˆ’$â€¦` for losses, neutral `You passed` / `Break-even`.

**Files changed:** `apps/web/lib/sampleScenarios.ts`, `apps/web/app/play/classic/run/page.tsx`

**How to run:** unchanged

**Tests:** 24 passing / 0 failing â€” `pnpm test`; `pnpm typecheck` clean; `pnpm lint` clean (no warnings or errors).
...
### 2026-07-03 â€” Implementor â€” H005 A001 Fix-ups

**What changed:**
- Part A: Fixed final-round dead-end in `run/page.tsx` â€” guard no longer blocks locked/reveal/summary views when `scenario` is undefined (changed `(view === 'round' || view === 'locked')` to `view === 'round'`).
...
**Tests:** 24 passing / 0 failing â€” `pnpm test`; `pnpm typecheck` clean; `pnpm lint` clean (no warnings or errors). grep for interpolated `border-${`/`bg-${`/`text-${` in run/page.tsx returned zero matches.
...
### 2026-07-03 â€” Orchestrator â€” Playtest round 2 (D019/D020, H006, role/roadmap)

**What changed:**
- Triaged 4 more playtest notes. Point "guess by name/ticker, case-forgiving" was
  already implemented (normalizeGuess + tickers in acceptedNames) â€” no work.
...
- D020 + H006: expand placeholder pool 6â†’12 (orchestrator-authored, leak-checked)
  and make `buildRunScenarioList` exhaust the pool before repeating; plus a clearer
  win/loss reveal banner. H006 depends on H005 (same files) â€” runs after it.
- Sounds/animation logged as a Phase 9 TODO (roadmap).

**Next recommended task:** Run H005 â†’ re-audit A002 â†’ commit/close Phase 1 â†’ run H006.

### 2026-07-03 â€” Orchestrator â€” A001 review + H005 fix-up
...
**Next recommended task:** Run H005 (Implementor) â†’ R005 â†’ re-audit A002 â†’ commit.
...
### 2026-07-03 â€” Orchestrator â€” Playtest decisions D013â€“D016 + H003
...
- Decisions logged: D013 return-mix rebalance + content guideline, D014 wrong
  ...
  (+2/âˆ’1/0, soul.md amended), D016 $1 bankruptcy floor.
...
**Next recommended task:** Run H003 (Implementor) â†’ R003 review â†’ then Auditor
A001 covering H001+H002+H003 â†’ orchestrator commits the prototype.

### 2026-07-03 â€” Implementor â€” H002 Design Alignment
...
- Sparkline component: added `variant` prop â€” lookback always son-signalCyan, outcome son-green/son-red by direction
- Difficulty selector: added explainer line per difficulty (Easyâ†’"More direct clues.", Mediumâ†’"Balanced clues.", Hardâ†’"Less obvious company context.")
- Added "Call locked" view state between round and reveal (D011): Lock In â†’ centered card with "Call locked.", your call/confidence/at risk, "Reveal Result" button â†’ reveal
...
**How to run:** unchanged â€” `pnpm install && pnpm dev && pnpm test` from repo root

**Tests:** 18 passing / 0 failing â€” `pnpm test` (all H001 tests still green)
...
### 2026-07-03 â€” Orchestrator â€” Report workflow + design pack adoption
...
### 2026-07-03 â€” Implementor â€” H001 Phase 0 + 1 Prototype

**What changed:**

*Part A â€” Monorepo scaffold (Phase 0):*
...
- `src/scoring.ts`: scoreRound â€” pass (0/0/same/âˆ’0.25/null), long/short (stake Ã— return, capped loss, wasCorrect = rawReturn > 0)
...
*Part B5â€“B6 â€” Tests (all passing):*
- `tests/scoring.test.ts`: 11 cases â€” correct/wrong long, correct/wrong short, pass, all-in win/loss, bankruptcy via capped short, short loss capped, calculateStake all levels, missing confidence throws
- `tests/run.test.ts`: 7 cases â€” createRunState defaults (3 difficulties), bankruptcy â†’ throw, completed after totalRounds, immutability, summarizeRun stats

*Part C â€” Sample scenario data:*
...
**Next recommended task:** Auditor review (A001) of handoff H001. Manual walkthrough of acceptance criteria 7â€“14 (full 20-round run, pass behavior, bankruptcy, signal score math, mobile 375px viewport, confidence button live dollar amounts).

### 2026-07-03 â€” Orchestrator â€” Groundwork setup

**What changed:**
- Initialized git repository; remote `origin` â†’
